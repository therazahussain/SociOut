    ...
    return (
        <>
            ...
            >
                ...
                <Typography fontWeight="bold" fontSize="clamp(1rem, 1.5rem, 2.2rem)">Delete Post.</Typography>
                </DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                    <Typography fontSize="clamp(.8rem, 1rem, 1.25rem)"> Do you Want to Delete This Post ?</Typography>
