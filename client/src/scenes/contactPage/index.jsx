...
const validationSchema = yup.object({
    name: yup.string().min(3, "Name must be of minimum 3 Characters.").required(),
          ...
          >
            <Box sx={{ mb: "1.5rem" }}>
              ...
              <Typography
                ...
                color="primary"
              >
                {block ? "Your Account has been blocked due to Safety Concern Please Contact through this form we will get back to you as soon as possible!" : "Write Down your Query we will get back to you Soon!"}
              </Typography>
            </Box>
